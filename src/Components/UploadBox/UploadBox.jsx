function UploaderBox({ imgSrc, isBanner, title }) {
  return (
    <div
      before={title}
      className={`relative flex justify-center border-2 border-[#133141] p-4 before:absolute before:left-[20px] before:top-[-14px] before:rounded-md before:bg-white before:px-4 before:text-slate-900 before:content-[attr(before)] md:h-[300px]  ${
        isBanner && "md:w-[80%]"
      }`}
    >
      <div
